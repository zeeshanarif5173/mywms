...
export default function CreateBillPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.vendorId || !formData.branchId || items.some(item => !item.description)) {
    ...
    try {
      ...
      if (response.ok) {
        router.push('/admin/accounts/bills')
      } else {
  ...
  return (
    <div className="p-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {/* Totals */}
        <div className="bg-white p-6 rounded-lg shadow">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Bill Totals</h3>
