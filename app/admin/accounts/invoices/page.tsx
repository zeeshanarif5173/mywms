  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        ...
        <Link
          href="/admin/accounts/invoices/create"
      ...
      <div className="bg-white p-6 rounded-lg shadow mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
          ...
          <button
            onClick={() => setFilters({ status: '', branchId: '', customerId: '', startDate: '', endDate: '' })}
              ...
              {invoices.map((invoice) => (
                <tr key={invoice.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                    <Link
                      href={`/admin/accounts/invoices/${invoice.id}`}
                      className="text-blue-600 hover:text-blue-900"
                    >
                      View
                    </Link>
                    <Link
                      href={`/admin/accounts/invoices/${invoice.id}/edit`}
                    ...
                    {invoice.status !== 'PAID' && invoice.status !== 'CANCELLED' && (
                      <Link
                        href={`/admin/accounts/invoices/${invoice.id}/payment`}
